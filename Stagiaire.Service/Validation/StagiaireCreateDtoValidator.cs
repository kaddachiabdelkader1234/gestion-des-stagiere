...
public class StagiaireCreateDtoValidator : AbstractValidator<StagiaireCreateDto>
{
    public StagiaireCreateDtoValidator()
    {
        // French messages: these strings reach the user directly via the shared error shape.
        RuleFor(x => x.Nom)
        ...
        // A stage spanning years is a data-entry error, not a real internship.
        RuleFor(x => x)
