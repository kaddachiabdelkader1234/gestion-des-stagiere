...
/// <summary>
/// Admin-only audit trail for convention actions: who generated or signed what, when.
/// Exposed at <c>/api/v1/conventions/audit</c> so the gateway routes it to Convention.Service
/// via the existing <c>/api/v1/conventions/**</c> predicate — no gateway config changes needed.
/// </summary>
/// <remarks>
...
/// </remarks>
[ApiController]
[Route("api/v1/conventions/audit")]
[Produces("application/json")]
[Authorize(Roles = "ADMIN")]
[ProducesResponseType(typeof(ApiErrorResponse), StatusCodes.Status401Unauthorized)]
[ProducesResponseType(typeof(ApiErrorResponse), StatusCodes.Status403Forbidden)]
public class ConventionAuditController(AppDbContext dbContext) : ControllerBase
{
    /// <summary>
    /// Lists convention audit entries with server-side paging and filtering.
    /// </summary>
    [HttpGet]
